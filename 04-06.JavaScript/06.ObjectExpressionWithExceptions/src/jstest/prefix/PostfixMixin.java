...
public class PostfixMixin {
    ...
    public static void testErrors(final PrefixParsingErrorTest test) {
        ...
        test.printParsingError("Missing (", "z (x y +) *)");
        test.printParsingError("Unknown operands", "( x y @@)");
        test.printParsingError("Excessive info", "(x y +) x");
        test.printParsingError("Empty operands", "()");
        ...
        test.printParsingError("Variable operands (0 args)", "(x)");
        test.printParsingError("Variable operands (1 args)", "(1 x)");
        test.printParsingError("Variable operands (2 args)", "(1 2 x)");
        test.printParsingError("Const operands (0 args)", "(0)");
        test.printParsingError("Const operands (1 args)", "(0 1)");
        test.printParsingError("Const operands (2 args)", "(0 1 2)");
    }
}