 ...
 */
public class PostfixSumsqLength extends ObjectExpressionTest {
    ...
    public PostfixSumsqLength(final int mode, final Language language, final String toString) {
        super(mode, language);
    ...
    public static void main(final String... args) {
        test(PostfixSumsqLength.class, PostfixSumsqLength::new, new ArithmeticTests(), args, ARITHMETIC_OBJECT, "prefix");
    }
