...
public class PrefixSumsqLengthTest extends PrefixParsingErrorTest {
    ...
    public static final Dialect SUMSQ_LENGTH_OBJECT = ObjectExpressionTest.ARITHMETIC_OBJECT.copy()
            .rename("sumsq", "Sumsq")
            .rename("length", "Length");

    public static class SumsqLengthTests extends ArithmeticTests {{
        any("sumsq", 3, PrefixSumsqLengthTest::sumsq);
        any("length", 5, args -> Math.sqrt(sumsq(args)));
    ...
    public static void main(final String... args) {
        test(PrefixSumsqLengthTest.class, PrefixSumsqLengthTest::new, new SumsqLengthTests(), args, SUMSQ_LENGTH_OBJECT, "prefix");
    }
}