...
public class PrefixParsingErrorTest extends PrefixParserTest {
    ...
    protected void testParsing() {
        ...
        printParsingError("Unknown operands", "(@@  x y)");
        printParsingError("Excessive info", "(+ x y) x");
        printParsingError("Empty operands", "()");
        ...
        printParsingError("Variable operands (0 args)", "(x)");
        printParsingError("Variable operands (1 args)", "(x 1)");
        printParsingError("Variable operands (2 args)", "(x 1 2)");
        printParsingError("Const operands (0 args)", "(0)");
        printParsingError("Const operands (1 args)", "(0 1)");
        printParsingError("Const operands (2 args)", "(0 1 2)");
    }
