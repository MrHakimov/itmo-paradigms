 ...
 */
public class PrefixSumexpSoftmax extends PrefixParsingErrorTest {
    ...
    public static class SumexpSoftmaxTests extends ArithmeticTests {{
        any("sumexp", 3, PrefixSumexpSoftmax::sumexp);
    ...
    protected PrefixSumexpSoftmax(final int mode, final Language language, final String toString) {
        super(mode, language, toString);
        insertions = "()+*/@ABC";
    }

    public static void main(final String... args) {
        test(PrefixSumexpSoftmax.class, PrefixSumexpSoftmax::new, new SumexpSoftmaxTests(), args, SUMEXP_SOFTMAX_OBJECT, "prefix");
    }
}